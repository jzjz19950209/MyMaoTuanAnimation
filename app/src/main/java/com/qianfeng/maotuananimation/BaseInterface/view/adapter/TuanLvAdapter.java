...
public class TuanLvAdapter extends BaseAdapter{
    private List<TuanBean.NearbyBean> list;
    private Context context;
    private LayoutInflater inflater;

    public TuanLvAdapter(List<TuanBean.NearbyBean> list, Context context) {
        this.list = list;
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        TuanBean.NearbyBean bean=list.get(i);
